...
Version **0.4.7** adds macOS and Windows install steps to the
[LT-FH exercise](https://bvilhjal.github.io/ATIG_2026/teaching_days/2026-09-24/LTFH/LTFH_exercise.html)
Setup section: Git, Python 3.12 or 3.13, NumPy, SciPy, and optional Numba.
It remains a Python practical on family-history liability scores with student
and worked-answer notebooks. The [PCA practical](https://bvilhjal.github.io/ATIG_2026/teaching_days/2026-09-10/PCA/PCA_tutorial.html)
