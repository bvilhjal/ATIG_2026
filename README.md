...
Version **0.4.10** polishes the
[LT-FH exercise](https://bvilhjal.github.io/ATIG_2026/teaching_days/2026-09-24/LTFH/LTFH_exercise.html):
its three figures are regenerated by a committed script with clearer labelling,
the answer key adds a Part C bar chart and per-panel correlations, and the code
carries a few more explanatory comments. Python setup lives on its own
[setup page](setup.html). The [PCA practical](https://bvilhjal.github.io/ATIG_2026/teaching_days/2026-09-10/PCA/PCA_tutorial.html)
