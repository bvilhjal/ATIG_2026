...
Version **0.4.8** moves Python setup to its own
[setup page](setup.html): macOS, Windows, or Anaconda, including Git, NumPy,
SciPy and optional Numba. The
[LT-FH exercise](https://bvilhjal.github.io/ATIG_2026/teaching_days/2026-09-24/LTFH/LTFH_exercise.html)
links to it. The exercise remains a Python practical on family-history
