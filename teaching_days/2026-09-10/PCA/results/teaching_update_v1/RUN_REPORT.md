...
21 checks in about 30 seconds. Both HTML documents retain all 14 questions;
...
comparison; the exported PC scores retain their original signs.

The refresh checked that all eight fitting-related code chunks and the input
hashes match the original run. It reused the saved PCA models and outlier
...
See `results/teaching_update/validation.tsv` and `refresh_info.json`.
